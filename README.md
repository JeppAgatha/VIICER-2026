...
Live Monitoring Dashboard with a Leaflet map showing 3 stationary i-RIS units and 1 mobile i-BUSS unit that patrols with simulated GPS jitter
Station Status grid classifying every unit as SAFE / CAUTION / UNSAFE from four simulated readings (dissolved oxygen, fish density, pH, lead)
...
Setup
Clone the repo
cd into the site root (the folder containing index.html)
Start a local server:
   python -m http.server 8000
Open http://localhost:8000/index.html
Click Log In and use one of the demo accounts below to reach the dashboard
🔑 Demo Accounts
Role	Email	Password
